...
const handleSaveDraft = async (e) => {
  ...
  await fetch("API_DRAFTS", {
    ...
    body: JSON.stringify({
      league: "bundesliga",   // so we know which league later
      ...DEFAULT_MATCH,
    }),
  });
  ...
  return (
    <Container className="py-4">
      <h2 className="mb-3">Admin • Bundesliga</h2>
          ...
          <Card style={{ borderRadius: 12, overflow: "hidden", boxShadow: "0 4px 8px rgba(0,0,0,0.08)" }}>
            ...
            >
              <div className="d-flex align-items-center gap-2">
                <img src="https://flagcdn.com/w20/de.png" alt="flag" style={{ width: 24, height: 16 }} />
